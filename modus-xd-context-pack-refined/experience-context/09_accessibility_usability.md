...
**Inherits Modus Experience Standards.** The default here is WCAG 2.2 AA plus the standard keyboard, focus, screen-reader, contrast, and reduced-motion rules defined in the Modus Experience Standards. Fill this file in only with what differs for *this* product (higher target on a regulated flow, specific components, project risks); do not restate the defaults. Log any deviation as an `[Experience]` decision.

## Accessibility Target

**Target standard:** Modus default (WCAG 2.2 AA) / raised to AAA on [criteria] / Client standard / Other
