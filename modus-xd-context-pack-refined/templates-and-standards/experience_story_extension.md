...
State only what is specific to this story; general standards live in `../experience-context/09_accessibility_usability.md`.
...
Name events per the guidance in `../experience-context/11_experience_measurement.md`.
