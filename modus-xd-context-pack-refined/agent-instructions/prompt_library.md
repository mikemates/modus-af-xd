...
To draft context files from raw transcripts, research, or client artifacts, use the staged prompts in `intake_workflow.md`. The prompts here are for reviewing, generating, and refining an existing pack.
