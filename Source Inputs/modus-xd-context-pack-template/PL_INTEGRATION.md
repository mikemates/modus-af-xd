...
Use this XD context pack for:

| XD File | Purpose |
|---|---|
| 00_experience_mode.md | Select the design operating mode and workflow model. |
| 01_experience_intent.md | Translate product intent into user behavior and experience quality. |
| 02_users_tasks_roles.md | Define roles, jobs, permissions, expertise, and context of use. |
| 03_journeys_flows.md | Define hero flows, secondary flows, handoffs, and failure paths. |
| 04_ia_object_model.md | Define navigation, routes, objects, relationships, and terminology. |
| 05_sandbox_manifest.md | Map sandbox routes/states to flows, decisions, backlog, and implementation relevance. |
| 06_interaction_states.md | Define states, validation, errors, confirmations, permissions, and behavior. |
| 07_components_patterns.md | Define component library, pattern usage, gaps, and system constraints. |
| 08_content_language.md | Define terminology, labels, copy, tone, and language rules. |
| 09_accessibility_usability.md | Define accessibility, usability, responsive, and compatibility expectations. |
| 10_experience_acceptance.md | Define UX acceptance, review process, blockers, and design debt. |
| 11_experience_measurement.md | Define task success, friction, and behavior instrumentation. |
